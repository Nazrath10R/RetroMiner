...
# java -cp PeptideShaker-X.Y.Z.jar eu.isas.peptideshaker.cmd.PathSettingsCLI -temp_folder /data/home/btx157/pride_reanalysis/temp -log /data/home/btx157/pride_reanalysis/logs
