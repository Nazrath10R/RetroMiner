...
# write.table(df, filename, sep = "\t", row.names=FALSE)
    ...
    # levels(variant_filtered_result[,2]) <- c(levels(variant_filtered_result[,2]), "LINE_1_HS_32_ORF1p")
    # variant_filtered_result[2,2] <- "LINE_1_HS_32_ORF1p"

    # levels(variant_filtered_result[,2]) <- c(levels(variant_filtered_result[,2]), "LINE_1_HS_33_ORF2p")
    # variant_filtered_result[2,2] <- "LINE_1_HS_33_ORF2p"
