...
# Deamidation of N, Deamidation of Q, Amidation of the protein C-term, Pyrolidone from Q, Phosphorylation of S, 
# Carbamilation of K, Carbamilation of protein N-term"

#------------------------------------------------------------#

SAMPLE=$1     #PXD
DATABASE=$DIR/human_proteome/human_variants_proteome_concatenated_target_decoy.fasta
PRECURSOR_TOLERANCE=1.6
PREC_UNIT=0
...
MAX_MISSED_CLEAVAGES=2
FIXED_MODIFICATIONS="Carbamidomethylation of C"
VARIABLE_MODIFICATIONS="Oxidation of M, Deamidation of N, Deamidation of Q"
...
Rscript $SCRIPTS/log.R --PXD "$PXD" --IN "parametered"
